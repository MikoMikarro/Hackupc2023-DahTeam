...
class HighlightObjectOperator(bpy.types.Operator):
    ...
    panels_distance = 5.0
    panels_sep = 3.0
    bpy.context.scene.my_properties.selectionState = 3
    ...
    def execute(self, context):
        ...
        if scene.my_properties.selectionState == 1:
        ...
        scene.my_properties.elapsedTime += 1

        if new_selected_obj != '':
            if scene.my_properties.selectedObject != new_selected_obj:
                scene.my_properties.selectedObject = new_selected_obj
                scene.my_properties.elapsedTime = 0
            elif scene.my_properties.elapsedTime >= max_time_to_select:
                print('Selected: ', scene.my_properties.selectedObject)
                if scene.my_properties.selectionState ==2 and scene.my_properties.selectedObject in self.textures+self.styles:
                    scene.my_properties.selectionState = 3
                elif scene.my_properties.selectionState == 0:
                    scene.my_properties.selectionState = 1
                elif scene.my_properties.selectionState == 2 and scene.my_properties.selectedObject == 'Back':
                    scene.my_properties.selectionState = 3
        ...
        percentage = min(1.0, scene.my_properties.elapsedTime / max_time_to_select)
        print(percentage)
        if percentage > 0:
        ...
        print(scene.my_properties.selectionState)
        return {'FINISHED'}
